...
const resourceCategories: ResourceCategory[] = [
  {
    ...
    description: "Find answers to common questions about peerLoan",
    ...
    items: [
      ...
      {
        title: "Borrowing",
        description: "Questions related to borrowing on peerLoan",
        path: "/resources/faq/borrowing",
      },
      {
        title: "Lending",
        description: "Questions related to lending on peerLoan",
    ...
    items: [
      {
        ...
        description: "Basic guides to start using peerLoan",
        path: "/resources/docs",
      },
      {
  ...
  },
  {
    id: "community",
    title: "Community",
    description: "Join the peerLoan community and connect with others",
      ...
      <main className="flex-grow relative">
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Explore our comprehensive resources to learn more about peerLoan, find answers to your questions,
